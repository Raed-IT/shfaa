...
} elseif ($_instance->childHasBeenRendered('DNlC2Rx')) {
    $componentId = $_instance->getRenderedChildComponentId('DNlC2Rx');
    $componentTag = $_instance->getRenderedChildComponentTagName('DNlC2Rx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DNlC2Rx');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('DNlC2Rx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('9RbUCDZ')) {
    $componentId = $_instance->getRenderedChildComponentId('9RbUCDZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('9RbUCDZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9RbUCDZ');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('9RbUCDZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH F:\xampp\htdocs\shfaa\resources\views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>