...
} elseif ($_instance->childHasBeenRendered('mbPRbdb')) {
    $componentId = $_instance->getRenderedChildComponentId('mbPRbdb');
    $componentTag = $_instance->getRenderedChildComponentTagName('mbPRbdb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mbPRbdb');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('mbPRbdb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH F:\xampp\htdocs\shfaa\resources\views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>